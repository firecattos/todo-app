...
class TodoList{
    ...
    addTodo(title){
        this.todos.push(new Todo(title, crypto.randomUUID()));
    }
...
//refresh closures, it seems I've used them without actively remembering them
...
function renderingArea(renderElement){
